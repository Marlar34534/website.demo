...
function sprawdz(nr)
{
    ...
    if(haslo ==haslo1)
    {
        document.getElementById("alfabet").innerHTML = "Wygrałeś, hasło to: "+ haslo +'<br><br><span style="cursor:pointer; color:green;" onclick="location.reload()" class="reset">OD NOWA</span>'
    }
    
    //przegrana

    if(ile_skuch>=9){
        document.getElementById("alfabet").innerHTML = "Przegrałeś, hasło to: "+ haslo +'<br><br><span style="cursor:pointer; color:red;" onclick="location.reload()" class="reset">OD NOWA</span>'
    }
